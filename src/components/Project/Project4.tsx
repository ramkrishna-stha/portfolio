...
export default function ProjectsSection() {
  ...
  return (
    <section
      id="projects"
      className="section projects h-screen  relative overflow-hidden "
      ref={containerRef}
    >
            ...
            >
              <div className="item-frame absolute inset-0 w-full h-full flex flex-col justify-center items-center p-4">
                ...
                <div className="text-projects-wrapp absolute top-6 md:-top-24 left-0 -translate-x-1/2 z-20 pointer-events-none">
                  <div className="text-projects text-2xl md:text-4xl lg:text-8xl font-semiblod text-black drop-shadow-2xl uppercase tracking-wider opacity-0 translate-y-1/2 transition-all duration-500">
                    {project.name}
                  </div>
                </div>
